...
import CateExploreDropdown from "./cateExploreDropdown";
import CateTabModal from "./cateTabModal";
import TabModal from "../modal/tabModal";
import LoginModal from "../modal/loginModal";
import RegisterModal from "../modal/registerModal";

function NavbarRightbar({
  handleExploreClick,
  setShowDropdown,
  showDropdown,
  ...
  return (
    <section>
      <div className="categories-nav__link">
        <NavLink to="business">
          <span className="categories-fiverr-business">Fiverr Business</span>
        </NavLink>

        <span onClick={handleExploreClick}>Explore</span>
        {showDropdown && (
          <CateExploreDropdown onClick={() => setShowDropdown(showDropdown)} />
        )}
        <NavLink
          onClick={() => setShowLanguageDialog(true)}
          className="NavLink"
        >
          <span className="categories-nav-english">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
        ...
        <NavLink to="start_selling" className="categories-navLink">
        ...
        <button onClick={() => setOpenModal(true)} className="categories-join">
          Join
        </button>
